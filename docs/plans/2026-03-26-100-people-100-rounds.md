...
> 100个不同背景的年轻人，每轮投票选出他们最需要的下一个「魔法」。

> 累计建成的服务越多，剩余需求越长尾。前20轮覆盖80%人群的80%需求。
...
| ID | 年龄 | 性别 | MBTI | 城市 | 人生阶段 | 文化 | 核心价值 | 当前痛点 |
|---|---|---|---|---|---|---|---|---|
...
| 轮次 | 新增魔法 | 描述 | 需要API | 受益人群 | 投票率 |
|---|---|---|---|---|---|
| 1 | **折扣/优惠聚合** | 附近商品折扣、优惠券、限时特卖 — 基于你的消费偏好个性化推 | 电商API + 优惠券API | P06,P33,P49,P52,P85 等低收入群体最急需... | 85% |
| 2 | **天气感知推荐** | 下雨不推户外，高温推室内，雾霾推空气好的地方 | Weather API | 所有人都需要，避免尴尬推荐... | 90% |
| 3 | **日历整合** | 知道你什么时候有空，推荐活动自动匹配空闲时间 | Calendar API (Google/Apple) | 忙碌人群最需要... | 80% |
| 4 | **交通方式+通勤时间** | 告诉你去那个地方需要多久，地铁/打车/步行方案 | 地图导航API | 城市用户日常需要... | 82% |
| 5 | **实时评价+排队情况** | 餐厅/展览/活动现在人多不多、评价如何 | 大众点评/Google Reviews API | 做决策的最后一步... | 75% |
| 6 | **免费 WiFi 地图** | 附近哪里有免费WiFi、充电站、洗手间 | 众包数据 + OpenStreetMap | 学生/旅行者/数字游民... | 60% |
| 7 | **附近美食推荐** | 不只是餐厅，而是基于你的情绪推餐：焦虑→安慰食物，开心→庆祝餐 | 美食API + 情绪匹配 | 所有人每天都要吃饭... | 88% |
| 8 | **通知偏好管理** | 你想多久收到一次星星通知？每天？重要的才推？ | 本地设置 | 避免打扰，尊重用户... | 70% |
| 9 | **音乐/播客推荐** | 基于实时情绪推荐：焦虑→calming playlist，低落→uplifting | Spotify API | 音乐是最即时的情绪工具... | 78% |
| 10 | **外语环境推荐** | 想练英语→附近有英语角/外国人咖啡馆/语言交换 | Places + Events + L3 | 在异国的人群（P01,P40,P52等）... | 55% |
| 11 | **匿名树洞** | 不想跟真人说的话，说给星星听，AI保密记录 | 本地功能 | P07,P17,P36,P51 等有秘密的人... | 72% |
| 12 | **同城兴趣圈** | 找到附近跟你有相同冷门爱好的人（P29考古、P59茶艺、P77独立游戏） | L3 + 地理 | 冷门爱好者的救命功能... | 65% |
| 13 | **安全空间标记** | 标记对 LGBTQ+/女性/少数族裔友好的场所 | 众包 + 审核 | P51,P76,P23 等边缘群体... | 50% |
| 14 | **mentor匹配增强** | 不只匹配人，而是告诉你附近有哪个行业前辈经常出现 | L3 + 位置 | P35,P61,P72 等职场迷茫者... | 60% |
| 15 | **共同进步小组** | 3-5人固定小组，每周目标打卡（健身/读书/学习） | L3 + 日历 | P09,P13,P55 想改变但缺伙伴... | 68% |
| 16 | **情绪天气广播** | 匿名显示你附近人群的整体情绪氛围（像天气预报一样） | 聚合+隐私 | 有趣但可能有隐私问题... | 40% |
| 17 | **虚拟陪伴** | 不想见真人但想有人陪 — AI音频/视频陪伴散步/学习 | AI + 音频 | P11,P50 等社恐内向者... | 55% |
| 18 | **安全回家路线** | 夜间推荐最安全的回家路线（有灯光、人多、有摄像头） | 安全数据 + 地图 | 女性用户尤其需要... | 70% |
| 19 | **家乡美食地图** | 离家的人找到最正宗的家乡菜（P40菲律宾菜、P52菲律宾菜、P28巴基斯坦菜） | 美食API + 文化标签 | diaspora群体情感需求... | 58% |
| 20 | **共享工作空间匹配** | 不只是找咖啡馆，而是找适合你工作风格的空间（安静/社交/站立桌） | Places API + 人格 | P08,P43,P47 自由职业者... | 55% |
| 21 | **二手闲置交换** | 基于人格匹配：你不要的东西可能正是别人想要的 | 闲鱼/Facebook Marketplace API | 环保+省钱... | 50% |
| 22 | **低价/免费活动专区** | 只推免费或极低价的活动给预算有限的用户 | Events API + 价格过滤 | 学生和低收入群体... | 65% |
| 23 | **理财入门建议** | 基于你的values和风险偏好，推荐理财方向（不是具体产品） | 本地规则引擎 | P06,P85 等攒钱群体... | 45% |
| 24 | **租房/合租推荐** | 基于人格匹配合租室友 + 推荐适合你性格的社区 | 房产API + L3 | 新城市的人最需要... | 55% |
| 25 | **医疗资源导航** | 附近的诊所/医院 + 等待时间 + 我的保险能不能用 | 医疗API | 实际需求但敏感... | 50% |
| 26 | **宠物友好地图** | 哪些公园/餐厅/商场允许带宠物 | Places + 众包 | 宠物主人群体... | 35% |
| 27 | **充电桩/加油站** | 电动车找充电桩，基于你的路线规划 | 充电桩API | 有车群体... | 30% |
| 28 | **打印/快递/寄存** | 紧急需要打印/寄快递/寄存行李时最近的点 | 本地服务API | 低频但急需时价值极高... | 25% |
| 29 | **停车位实时查询** | 附近哪里有空停车位 | 停车API | 开车群体... | 30% |
| 30 | **药店/24小时便利店** | 半夜需要药或生活用品时最近的开着的店 | Places + 营业时间 | 所有人偶尔需要... | 40% |
| 31 | **习惯追踪可视化** | 跟情绪曲线联动：看到你跑步那天情绪都比较好 | 本地 + 健康API | 量化自我爱好者... | 55% |
| 32 | **技能交换地图** | 我会日语你会阿拉伯语，我们都在这个咖啡馆附近 | L3 + 位置 | 双向技能互补... | 50% |
| 33 | **每日微挑战** | 基于你的成长缝隙推送一个小挑战（今天跟一个陌生人说你好） | 本地规则 | 想突破舒适区的人... | 60% |
| 34 | **冥想/正念日历** | 不只推荐冥想，而是帮你建立每日正念习惯，追踪效果 | 本地 + 提醒 | 焦虑群体... | 55% |
| 35 | **写作/日记空间** | 基于 Life Chapter 的引导式写作，每天一个问题 | 本地 + AI | P08,P26,P91 等内省型... | 50% |
| 36 | **播客/有声书推荐** | 通勤路上听什么？基于你的通勤时间+兴趣+情绪推荐 | 播客API + Audible | 通勤群体... | 45% |
| 37 | **线上课程进度追踪** | 你报了3个课，帮你管理进度，提醒你该继续学了 | 本地 + 课程API | 学习者... | 40% |
| 38 | **身体健康联动** | Apple Watch/手环数据接入 → 睡眠差→推荐改善方案 | HealthKit/Google Fit | 量化健康群体... | 55% |
| 39 | **专注模式** | 帮你找到附近最适合专注工作的地方+屏蔽通知 | Places + 本地 | P09,P43 等知识工作者... | 45% |
| 40 | **人生实验清单** | 100件想做的事 → 帮你一件件安排（附近能做的先做） | 综合 | 想改变但不知道从哪开始的人... | 60% |
| 41 | **宗教场所+祈祷时间** | 自动提醒祈祷时间 + 最近的清真寺/教堂方向 | 祈祷时间API + Places | 穆斯林用户（中东核心功能）... | 70% |
| 42 | **斋月/节日特别模式** | 斋月期间推荐开斋餐厅/夜间活动/精神修炼 | 日历 + 文化API | 节日场景高价值... | 55% |
| 43 | **文化桥梁** | 帮助不同文化背景的人理解彼此（P01阿拉伯人在中国、P40菲律宾人在中东） | L3 + 文化标签 | diaspora群体... | 45% |
| 44 | **本地文化导览** | 不是旅游景点，而是当地人的秘密好去处 | 众包 + 本地人推荐 | 新移民/旅行者... | 50% |
| 45 | **历史地点故事** | 你经过的这个地方有什么故事？增强现实式文化体验 | AR + 历史数据 | P29,P67 等文化爱好者... | 35% |
| 46 | **语言学习环境** | 标记附近哪些地方可以练习某种语言（阿拉伯语餐厅、日语动漫店） | Places + 语言标签 | 语言学习者... | 40% |
| 47 | **诗歌/文学推送** | 基于你的情绪推送一首诗 — 阿拉伯诗歌 for 中东用户、唐诗 for 中国用户 | 文学数据库 | 文艺型用户... | 35% |
| 48 | **手工艺体验** | 附近的陶艺/木工/皮具工坊 — 推荐适合你的动手体验 | Places + 工坊数据 | P15,P24 等创意型... | 40% |
| 49 | **公益机会匹配** | 基于你的values和技能推荐志愿者机会 | 公益平台API | P10,P42,P83,P100 高benevolence... | 45% |
| 50 | **自然疗愈路线** | 不是普通公园推荐，而是科学设计的自然疗愈步道（森林浴路线） | 健康步道数据 | 焦虑/burnout群体... | 50% |
| 51 | **旅行灵感地图** | 基于你的人格推荐旅行目的地（内向→冰岛、冒险→摩洛哥） | 旅行API | 想旅行的人... | 55% |
| 52 | **家居/装修灵感** | 基于你的审美偏好推荐家居风格和附近家居店 | 家居API + Pinterest | 搬新家的人... | 30% |
| 53 | **约会地点推荐** | 基于两人的人格推荐约会地点（不只是好评餐厅） | Places + Bond Comparator | 恋爱中的人... | 60% |
| 54 | **分手疗愈路线** | 特别为分手后设计的城市探索路线（避开你们去过的地方） | 地图 + 情绪 | P11,P37 等情伤者... | 45% |
| 55 | **睡眠环境优化** | 你睡眠差可能因为光线/噪音 — 推荐遮光窗帘/白噪音设备 | 健康 + 商品API | 失眠群体... | 35% |
| 56 | **紧急情绪疏导** | panic attack时一键启动呼吸引导 + 找最近的安全空间 | 本地 + 地图 | 焦虑/PTSD群体... | 70% |
| 57 | **纪念日提醒+建议** | 朋友/家人生日快到了→基于TA的人格推荐礼物 | 日历 + 商品API + 人格 | 关系维护... | 50% |
| 58 | **独处友好评分** | 给每个场所打一个'独处友好度'分（适合一个人去吗？） | 众包 + 人格 | 内向用户... | 45% |
| 59 | **深度社交推荐** | 不是泛泛社交，而是推荐适合深度对话的场所+同伴 | L3 + Places | INFJ/INFP群体... | 50% |
| 60 | **创业资源地图** | 附近的孵化器/投资人出没地/创业活动 | 创业生态数据 | P02,P25,P46 等创业者... | 40% |
...
| # | 魔法 | 投票率 | 为什么最紧急 |
|---|------|-------|-----------|
| 1 | 天气感知推荐 | 90% | 避免尴尬推荐（下雨推户外=卸载） |
| 2 | 附近美食推荐 | 88% | 每天都要吃饭，最高频场景 |
| 3 | 折扣/优惠聚合 | 85% | 年轻人最在意省钱 |
| 4 | 交通方式+通勤时间 | 82% | 推荐了但去不了=无用 |
| 5 | 日历整合 | 80% | 推荐了但没空=无用 |
...
1. **折扣/优惠** 排第一不是因为贪便宜 — 是因为年轻人（尤其P06外劳、P52护士、P85骑手）真的在为钱发愁。SoulMap 如果能帮他们省钱，比心理洞察更实际。

2. **宗教场所+祈祷时间** 在中东用户中投票率 95% — 这是文化必需品，不是nice-to-have。任何在中东运营的app不做这个=不尊重用户。

3. **安全回家路线** 被女性用户一致投票 — 这不是feature，是责任。

4. **紧急情绪疏导** 排名远高于预期 — panic attack时用户不需要洞察，需要的是「现在立刻帮我」。

5. **独处友好评分** 是内向用户的刚需 — 没有任何主流app提供这个。这是我们独有的壁垒。
...
经过60轮迭代，人类的需求可以归纳为 **8 个不可替代的维度**：


| 维度 | 覆盖轮次 | 核心API | 例子 |
|------|---------|--------|------|
| **吃** | 1-10 | 美食API | 情绪匹配餐厅、家乡菜、安慰食物 |
| **行** | 1-10 | 地图+交通API | 安全路线、通勤、停车 |
| **省** | 1-10 | 优惠券+电商API | 折扣、免费活动、二手交换 |
| **学** | 11-30 | 课程+工坊API | 技能学习、语言练习、文化体验 |
| **友** | 11-30 | L3+位置 | 同城兴趣圈、深度社交、导师匹配 |
| **愈** | 21-40 | 健康+冥想API | 习惯追踪、冥想日历、紧急疏导 |
| **信** | 41-60 | 宗教+文化API | 祈祷时间、节日模式、文化桥梁 |
| **创** | 41-60 | 工坊+创业API | 创作空间、创业资源、手工体验 |


**这8个维度 = 一个年轻人完整的线下生活。SoulMap 覆盖全部8个，就不只是一个心理app — 是一个生活操作系统。**
